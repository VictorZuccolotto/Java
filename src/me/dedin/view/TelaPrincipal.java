...
private void erroPopUp() {
	JOptionPane.showMessageDialog(this.tela, "Salvo com sucesso!");
}
...
private void salvar() {
	if (!textoNomeRemedio.getText().equals("") && !textoPreco.getText().equals("") 
		...
		JOptionPane.showMessageDialog(this.tela, "Digite os dados corretamente.");
	}
}
...
private void alterar() {
	...
	if (objetoDaLinha instanceof Integer) {
		...
		JOptionPane.showMessageDialog(this.tela, "Por favor, digite corretamente");
	}
}
...
private void deletar() {
	...
	if (objetoDaLinha instanceof Integer) {
		...
		JOptionPane.showMessageDialog(this.tela, "Item excluído com sucesso!");
	} else {
		JOptionPane.showMessageDialog(this.tela, "Por favor, selecionar o ID");
	}
}
}